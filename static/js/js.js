...
ahk.init = function(){
	...
	$("html,body,.section,.section img.bg,.maskbox").css({width:ahk.w+"px",height:ahk.h+"px"});
	...
	$(".rfsera").click(function(e){
		e.stopPropagation();
		$(".fsera").j_transform({y:"100%"});
		var id = $(this).attr("data-sc");
		setTimeout(function(){
			$("#anmf_"+id).j_transform({y:0})
		},100)
	});
...
ahk.fsera = function(){
	$(".fsera").j_transform({y:"100%"});
	setTimeout(function(){
		$(".fsera").j_transition({timingFunc:"ease",duration:"0.6s"});
	},200)
}
...
//场景内部效果
ahk.scene = function(){
	$("img,.tips,.resizeform,fsera").removeAnimation();

	switch(ahk.step){
		case 0:
			//$("#anm1_1").j_animation({name:"fadeIn",duration:"2s",timingFunc:"linear",delay:"0.2s"});
			$("#anm1_1").j_animation({name:"fadeInDown",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".2s"});
			$("#anm1_2").j_animation({name:"fadeInLeft",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".5s"});
			$("#anm1_3").j_animation({name:"fadeInRight",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".8s"});
			sys.tips();
			break;
		case 1:
			$("#anm2_13").j_animation({name:"fadeInDown",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".1s"});
			$("#anm2_1").j_animation({name:"zoomDown",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"0.2s"});
			$("#anm2_2").j_animation({name:"fadeInRight",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"1.4s"});

			$("#anm2_3").j_animation({name:"zoomDown",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"0.5s"});
			$("#anm2_4").j_animation({name:"fadeInRight",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"1.7s"});

			$("#anm2_5").j_animation({name:"zoomDown",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"0.8s"});
			$("#anm2_6").j_animation({name:"fadeInRight",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"2s"});

			$("#anm2_7").j_animation({name:"zoomDown",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"1.1s"});
			$("#anm2_8").j_animation({name:"fadeInRight",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"2.3s"});

			$("#anm2_12").j_animation({name:"fadeInLeft",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"1.4s"});
			$("#anm2_11").j_animation({name:"fadeInLeft",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"1.7s"});
			$("#anm2_10").j_animation({name:"fadeInLeft",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"2s"});
			$("#anm2_9").j_animation({name:"fadeInLeft",duration:"0.6s",timingFunc:"cubic-bezier(0.15, 1.04, 0.84, 0.99)",delay:"2.3s"});
			sys.tips();
			break;
		case 2:
			ahk.fsera();
			$("#anm3_0").j_animation({name:"fadeInDown",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".1s"});
			$("#anm3_1").j_animation({name:"fadeInLeft",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".3s"});
			$("#anm3_2").j_animation({name:"fadeInRight",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".3s"});
			$("#anm3_3").j_animation({name:"fadeInUp",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:".9s"});
			$("#anm3_14").j_animation({name:"fadeInUp",duration:"0.6s",timingFunc:"cubic-bezier(0.17, 0.5, 0.25, 1)",delay:"5s"});

			$(".rfsera").each(function(i){
				$("#anm3_"+(4+i)).j_animation({name:"bounceIn",duration:"1.2s",timingFunc:"cubic-bezier(0.63, 0.07, 0.41, 0.98)",delay:(1+0.3*(i+1))+"s"});
			})
	}
}
